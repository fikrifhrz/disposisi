            ...
            <div class="card-body">
                <form action="<?php echo site_url('admin/surat_masuk/edit') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" name="tgl_surat" value="<?=$surat->tgl_surat;?>" required />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" name="tgl_terima" value="<?=$surat->tgl_terima;?>" required />
                    </div>
                    <div class="mb-3">
